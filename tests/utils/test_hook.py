...
class TestHooks(unittest.TestCase):
    def test_private_profile_returns_true(self):
        with open(os.path.join(DATA, "private_json.txt")) as f:
    ...
    def test_private_profile_returns_false(self):
        with open(os.path.join(DATA, "public_json.txt")) as f:
    ...
    def test_hashtag_post_count_return_number(self):
        with open(os.path.join(DATA, "hashtag_json.txt")) as f:
    ...
    def test_shortcode_media_return_post_type(self):
        with open(os.path.join(DATA, "graphimage_json.txt")) as f:
